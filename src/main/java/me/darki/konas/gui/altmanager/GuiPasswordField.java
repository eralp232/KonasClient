    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = this.fontRenderer.drawStringWithShadow(s1.replaceAll(".", "*"), (float)l, (float)i1, i);
            }
            ...
            {
                j1 = this.fontRenderer.drawStringWithShadow(s.replaceAll(".", "*").substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (k != j)
            {
                int l1 = l + this.fontRenderer.getStringWidth(s.replaceAll(".", "*").substring(0, k));
