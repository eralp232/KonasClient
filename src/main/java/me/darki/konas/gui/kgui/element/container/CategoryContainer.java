...
public class CategoryContainer extends Element {
    ...
    public CategoryContainer(Module.Category category, float parentX, float parentY, float offsetX, float offsetY, float width, float height) {
