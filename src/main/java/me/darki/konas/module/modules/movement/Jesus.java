...
public class Jesus extends Module {
    private static Setting<Mode> mode = new Setting<>("Mode", Mode.SOLID);

    private static Setting<Boolean> glide = new Setting<>("Glide", false);
    private static Setting<Boolean> entityJesus = new Setting<>("EntityJesus", true);
    ...
    @Subscriber
    public void onWalkingPlayerUpdatePre(UpdateWalkingPlayerEvent.Pre event) {
